...
image: "/blog/banners/2024-01-30-how-to-do-research.png"
date: "2024-01-30"
categories: [Tutorial]
bibliography: references.bib
description: "An overview of my research methodologies"
---
...
<div class="lnk-outer">
 ...
 <div class="lnk-row lnk-orange">
  ...
  <div class="lnk-chips">
   <a href="https://pingfan.org/blog/2023-12-09-personal-website/" class="lnk-btn" target="_blank">How to Make a Personal Website</a>
  </div>
 </div>
</div>
...
This blog provides a concise overview of my research methodologies. It encompasses three core aspects:
...
I want to discuss some simple questions: Why do we do literature review and bibliography? What are the requirements for them? The usual answers are "I do so since my advisor wants me to, and he/she has some solid requirements." This interpretation is correct, but not enough. My interpretations are:
...
You might want to share some notes with your advisor or your other teammates. I'll discuss about them in the [Publication & Communication](#publication-communication) section.
...
[Google Scholar](https://scholar.google.com) is the starting point of doing research, and it's perhaps the largest database that we can access. You may search for any keywords with proper filtering to look for the possible outcomes that may interest you. You may also search for your advisor's name. His/her personal page will show the list of publications, along with the counts of citations in a bar chart in chronological order.

::: {style="text-align: center;"}
![***Figure 1**: Google Scholar: Stand on the shoulders of giants*](images/01_google_scholar.jpg){width="600"}
:::
...
::: {style="text-align: center;"}
![***Figure 2**: GWU Library provides more advanced searching and filtering techniques, and grants you access to some paid contents*](images/02_gw_library.jpg){width="600"}
:::
...
::: {style="text-align: center;"}
![***Figure 3**: Connected Papers: Enter keywords of a paper to start*](images/03_connected_papers_1.jpg){width="600"}
:::
...
::: {style="text-align: center;"}
![***Figure 4**: Connected Papers: Example of Dr Helveston 2023*](images/04_connected_papers_2.jpg){width="800"}
:::
...
::: {style="text-align: center;"}
![***Figure 5**: Click on this Zotero web browser button to save the literature you find on the web*](images/05_zotero_1.jpg){width="400"}
:::

Then, this literature resource should appear in your Zotero main interface. Below is the main interface:

::: {style="text-align: center;"}
![***Figure 6**: Zotero Main Interface*](images/06_zotero_2.jpg){width="800"}
:::
...
::: {style="text-align: center;"}
![***Figure 7**: Zotero add-on for Microsoft Word*](images/07_zotero_3.jpg){width="400"}
:::

::: {style="text-align: center;"}
![***Figure 8**: Zotero compatibility for RStudio*](images/08_zotero_4.jpg){width="400"}
:::

## Publication & Communication {#publication-communication}

Rome was not built in a day. It takes a considerable amount of time to do the research project. It's vital to have regular communication with your advisor. It could be face to face, online, email, or whatever method you both may prefer. Having your research resources available to your advisor and other team members is important. Then it comes to the publication and communication methods.
...
2.  **Private vs Public**:
    a.  GitHub repos are by default set as **private** as you create them, which is necessary for all your on-going projects since they are usually confidential. Then, you assign your advisor or anyone you want to cooperate with as **collaborator(s)**.
...
4.  **Namecheap** is used to buy and manage domains. It also lets you to manage DNS, which is important for linking your domain to Netlify. In fact, I bought [my domain](https://pingfan.org) at Namecheap.
...
> Above is just a brief introduction of which is which. If you are interested in building a website in this way, please go to another blog of mine: [How to Make a Personal Website](https://pingfan.org/blog/2023-12-09-personal-website/).

...
Here is one example of the output showcasing my profile. It supports both desktop and mobile layouts but content is the same.
...
<iframe class="profile-desktop" src="resources/pingfan-profile-en.html" width="100%" height="680px" style="border: 1.5px solid #D4D3EE; border-radius: 8px;"></iframe>
<iframe class="profile-mobile" src="resources/pingfan-profile-en-mobile.html" width="100%" height="900px" style="border: 1.5px solid #D4D3EE; border-radius: 8px;"></iframe>

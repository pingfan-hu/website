...
[Spokenly](https://spokenly.com/) converts text to speech and supports multiple languages. I use it daily on both my Mac and phone. It largely replaces hand-typing and produces well-structured texts. This blog post, and also the previous ones, are in fact constructed with great help from Spokenly.
...
[\@tw93](https://tw93.fun) recently released a collection of skills called [Waza](https://github.com/tw93/waza), which includes eight skills: `/think`, `/design`, `/check`, `/hunt`, `/write`, `/learn`, `/read`, and `/health`.

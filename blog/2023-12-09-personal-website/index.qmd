...
image: "/blog/banners/2023-12-09-personal-website.png"
date: "2023-12-09"
categories: [Tutorial]
...
You can use [Netlify](https://www.netlify.com) or [Namecheap](https://www.namecheap.com) to buy your personalized domain. For example, my domain is [pingfan.org](https://pingfan.org). It is bought from [Namecheap](https://www.namecheap.com) and deployed on [Netlify](https://www.netlify.com). If you do this, both the default Netlify domain and your customized domain will work. They are not replacing each other. Below is the example of my case:
...
The next step is to create the R project of your website. You can either clone [my website repo](https://github.com/pingfan-hu/website) or make from scratch.

### 2.1 Clone my repo

If you want to clone my repo, [proceed to the site](https://github.com/pingfan-hu/website), and click on the **Code** button or **Use this template** button. Both buttons are in green.
...
2.  I used the [Flatly](https://bootswatch.com/flatly/) and [Darkly](https://bootswatch.com/darkly/) themes for light and dark modes. These are free themes made by Bootswatch. There are 25 Bootswatch themes in total, all compatible with Quarto doc. You can access them in the **Themes** drop-down menu.

3.  I also used a customized `scss` file called `styles.scss` and a JS file called `styles.js`. Both `scss` and `js` files are used to define personal page layout settings and behaviors. The YAML grammar looks like this (You can see the full YAML code in the `_quarto.yml` file):

    ``` yaml
    format:
      html:
        theme:
          light: [flatly, styles/styles.scss]
          dark: [darkly, styles/styles.scss]
        include-after-body:
          text: |

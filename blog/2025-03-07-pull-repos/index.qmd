...
image: "/blog/banners/2025-03-07-pull-repos.png"
date: "2025-03-07"
categories: [Tutorial]
echo: true
eval: false
...
# Change this path to the root folder of your GitHub repos
cd "$HOME/Documents/GitHub" || exit 1

"$HOME/Documents/GitHub/pull-all-repos.sh"
```
...
You need to run this code in your Terminal:

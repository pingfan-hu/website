---
title: "My Take on Agentic Engineering - Part 1"
image: "/blog/banners/2026-03-26-agentic-engineering-1.png"
description: "Takeaways from effectively using AI for personal workflows, with a focus on Claude Code."
date: '2026-03-26'
...
To launch Claude Code, you need either a terminal or an IDE. Use an IDE when you want to live-trace your files and make changes on your own. Otherwise, use terminal.
...
Another way is to use an IDE. Navigate to your desired project directory, and launch Claude Code in terminal. No `cd` needed since terminal is already in the right directory:
...
I recommend reading the article to better understand the architecture — or just skip ahead and install the skill.

## Vibe Coding, Agentic Engineering, and Harness Design

Workflows have changed dramatically ever since LLMs came out. At first we called it "Vibe Coding" — you just vibe with the model, and it gives you code. The problem with "vibe" is that it's more like drawing a card: it's random, and the quality is not guaranteed. Even if there is a successful outcome, there's no way to reproduce it.

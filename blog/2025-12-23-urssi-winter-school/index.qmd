...
I'll use my [`tidyviz`](https://pingfan.org/blog/2025-12-16-tidyviz/) Python package as an example. This was created during the URSSI bootcamp. Here is a simplified structure of the package:
...
Our [`surveydown`](https://pingfan.org/researches/2024-surveydown/) R package is well-structured and can be used as an example:

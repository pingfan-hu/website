...
I'll use my [`tidyviz`](https://pingfanhu.com/researches/2025-tidyviz/) Python package as an example. This was created during the URSSI bootcamp. Here is a simplified structure of the package:
...
Our [`surveydown`](https://pingfanhu.com/researches/2024-surveydown/) R package is well-structured and can be used as an example:

...
Netlify has a [basic walk-through](https://www.netlify.com/blog/2016/09/29/a-step-by-step-guide-deploying-on-netlify/) of website deployment upon GitHub push, which should solve the problem in most cases. I also documented [my version of tutorial](https://pingfan.org/blog/2023-12-09-personal-website/). However, it requires to fully construct the website on user's local machine and push the built folder (usually the `_site/` folder) to the repository. To do this, I need to always fully rebuild all website pages locally anytime I make changes, and the `_site/` folder grows larger and larger over time.

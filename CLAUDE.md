...
- **Banner image generation**: Always use the nano-banana skill (Gemini CLI) to generate banner images. Never use Pillow or HTML/CSS rendering. See `.claude/rules/banner-image-generation.md` for the full workflow, prompt template, and style standard.

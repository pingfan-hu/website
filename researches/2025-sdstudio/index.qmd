---
title: sdstudio
image: "/researches/banners/2025-sdstudio.png"
author:
...
<div class="intro-links">
  <a href="https://sdstudio.surveydown.org" class="intro-btn" target="_blank"><i class="bi bi-browser-safari"></i> Website</a>
  <a href="https://github.com/surveydown-dev/sdstudio" class="intro-btn" target="_blank"><i class="bi bi-github"></i> GitHub</a>
  <a href="https://cran.r-project.org/web/packages/sdstudio/" class="intro-btn" target="_blank"><i class="bi bi-r-circle-fill"></i> CRAN</a>
  <a href="https://surveydown-dev.r-universe.dev/sdstudio" class="intro-btn" target="_blank"><i class="bi bi-r-square-fill"></i> R-univ</a>
</div>

## Slides

Presentation of `sdstudio` in [GW OSCON 2026](https://ospo.gwu.edu/open-source-conference-gw-oscon):

<iframe src="https://pingfan-hu.github.io/2026-gwoscon-sdstudio" width="100%" height="500px" style="border:2px solid #5654A2;"></iframe>

## Video

::: {style="width:100%; text-align:center; border:2px solid #5654A2;"}
{{< video https://www.youtube.com/watch?v=p00ivfg1B1M >}}
:::

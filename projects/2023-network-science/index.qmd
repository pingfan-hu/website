---
title: "Multi-layer Network Science"
image: "/projects/banners/2023-network-science.png"
date: "May, 2023"
categories: [Python, Research, Data Science, Transportation]
description: "A master-level multi-layer network analysis."
---

<div class="intro-links">
  <a href="https://pingfan.craft.me/2023-network-science" class="intro-btn" target="_blank"><i class="bi bi-file-earmark-text"></i> Documentation</a>
</div>

This project is a multi-layer network science study on the Mid-Atlantic region. It is a student research project for [the FEW's Lab](https://fewslab.org) managed by Prof Caitlin Grady.
...
The code can be modified so that you can expand to other selections of states, or to introduce other sources of `shp` files or `csv` files.

...
[<i class="bi bi-browser-safari"></i> Website](https://sdstudio.surveydown.org){.btn .btn-primary .m-1 style="width: 120px;"}
[<i class="bi bi-github"></i> GitHub](https://github.com/surveydown-dev/sdstudio){.btn .btn-primary .m-1 style="width: 120px;"}
[<i class="bi bi-r-circle-fill"></i> CRAN](https://cran.r-project.org/web/packages/sdstudio/){.btn .btn-primary .m-1 style="width: 120px;"}
[<i class="bi bi-r-square-fill"></i> R-univ](https://surveydown-dev.r-universe.dev/sdstudio){.btn .btn-primary .m-1 style="width: 120px;"}
:::
